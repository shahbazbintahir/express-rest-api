...
const sendForgetPasswordMail = async (options) => {
    //email configuration for template paths
    const viewPath = path.resolve(__dirname, '../../../templates/forgetPasswordEmail/');
    const partialsPath = path.resolve(__dirname, '../../../templates/forgetPasswordEmail');
